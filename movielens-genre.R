...
train = read.transactions('data/movielikes_genre_train.txt', 'single', cols = c('UserID', 'movie'))
test = read.transactions('data/movielikes_genre_test.txt', 'single', cols = c('UserID', 'movie'))
